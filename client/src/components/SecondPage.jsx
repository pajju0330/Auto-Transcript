...
import "./SecondPage.css"; // You can create a CSS file for styling
						...
						<tbody>
							<tr>
								<td rowSpan='1' colSpan='10'>
									First Year:(2010-2011) SEM-I
								</td>
							</tr>
							{courseDetails?.slice(0, 8).map((course) => {
								const {
									CourseCode,
									CourseTitle,
									Lecture,
								...
								return (
									<tr>
										<td contenteditable='true' style={{fontWeight:'100'}}>{CourseCode}</td>
										<td colSpan='4' contenteditable='true' style={{fontWeight:'100'}}>
											{CourseTitle}
										</td>
										<td contenteditable='true' style={{fontWeight:'100'}}>{Lecture}</td>
										<td contenteditable='true' style={{fontWeight:'100'}}>{Tutorial}</td>
										<td contenteditable='true' style={{fontWeight:'100'}}>{Practical}</td>
										<td contenteditable='true' style={{fontWeight:'100'}}>{Credits}</td>
										<td contenteditable='true' style={{fontWeight:'100'}}>B</td>
									</tr>
								);
							})}
							<tr>
								<td rowSpan='1' colSpan='10'>
									First Year:(2010-2011) SEM-II
								</td>
							</tr>
							{courseDetails?.slice(8, 16).map((course) => {
								const {
									CourseCode,
									CourseTitle,
									Lecture,
								...
								return (
									<tr>
										...
										<td contenteditable='true'>{Tutorial}</td>
										<td contenteditable='true'>{Practical}</td>
										<td contenteditable='true'>{Credits}</td>
				...
				<div
					...
					<button
						style={{
						  ...
						  onClick={() => navigate(`/admin/transcript/final/${id}`)}
